...
import './homeLoader.scss'; // Assuming you have the necessary CSS in a file named Flowers.css
...
const HomeLoader = () => {
    ...
    useEffect(() => {
        const timeoutId = setTimeout(() => {
            if (divRef.current) {
                divRef.current.classList.remove("not-loaded");
            }
        }, 1000);
    ...
    return (
        <div className="not-loaded" ref={divRef}>
            <div className="night"></div>
            <div className='flowerheading'>
                <h1> Anywhere</h1>
            </div>
